...
namespace CloneProm.Migrations
{
    ...
    [Migration("20260228175019_AddRatingAndReviewsToProduct")]
    partial class AddRatingAndReviewsToProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloneProm.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CloneProm.Models.Category", b =>
                {
                    b.HasOne("CloneProm.Models.Category", "ParentCategory")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("CloneProm.Models.OrderItem", b =>
                {
                    b.HasOne("CloneProm.Models.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CloneProm.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("CloneProm.Models.Product", b =>
                {
                    b.HasOne("CloneProm.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CloneProm.Models.Seller", "Seller")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CloneProm.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
