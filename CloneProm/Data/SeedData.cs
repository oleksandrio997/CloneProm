        ...
        public static async Task InitializeAsync(this IServiceProvider services)
        {
            ...
            try
            {
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = " Виробник:Apple\\r\\n \r\nМодель:MacBook Air 13 M3\\r\\n \r\nДіагональ екрану:13.6\\\\r\\n \r\nРоздільна здатність:2560×1664\\r\\n \r\nТип дисплея:Liquid Retina\\r\\n \r\nПроцесор:Apple M3\\r\\n \r\nКількість ядер CPU:8\\r\\n \r\nОперативна пам'ять:16 ГБ\\r\\n \r\nНакопичувач:512 ГБ SSD\\r\\n \r\nВідеоадаптер:Інтегрована графіка Apple\\r\\n \r\nОпераційна система:macOS\\r\\n \r\nАвтономність:До 18 годин\\r\\n \r\nВага:1.24 кг\\r\\n \r\nКолір:Space Gray\\r\\n \r\nГарантія:12 міс.",
                    Price = 49999.99m,
                    Quantity = 10,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Виробник:Logitech\\r\\n \r\nМодель:G102 Lightsync\\r\\n \r\nТип:Ігрова миша\\r\\n \r\nПідключення:Дротове\\r\\n \r\nІнтерфейс:USB\\r\\n \r\nТип сенсора:Оптичний\\r\\n \r\nМаксимальний DPI:8000\\r\\n \r\nКількість кнопок:6\\r\\n \r\nПідсвітка:RGB LIGHTSYNC\\r\\n \r\nДовжина кабелю:2.1 м\\r\\n \r\nКолір:Білий\\r\\n \r\nГарантія:24 міс.",
                    Price = 24.50m,
                    Quantity = 50,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Виробник:Razer\\r\\n \r\nМ модель:BlackWidow V3\\r\\n \r\nТип:Механічна клавіатура\\r\\n \r\nТип перемикачів:Razer Green\\r\\n \r\nПідключення:Дротове\\r\\n \r\nІнтерфейс:USB\\r\\n \r\nПідсвітка:Razer Chroma RGB\\r\\n \r\nФормат:Повнорозмірна\\r\\n \r\nМатеріал корпусу:Алюміній\\r\\n \r\nПідставка для рук:Так\\r\\n \r\nКолір:Чорний\\r\\n \r\nГарантія:24 міс.",
                    Price = 9999.99m,
                    Quantity = 20,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Бренд:Organic Cotton\\r\\n \r\nТип:Футболка\\r\\n \r\nМатеріал:100% бавовна\\r\\n \r\nТип тканини:Jersey\\r\\n \r\nКрій:Regular Fit\\r\\n \r\nСтать:Унісекс\\r\\n \r\nСезон:Весна/Літо\\r\\n \r\nКолір:Білий\\r\\n \r\nКраїна виробництва:Італія",
                    Price = 14.99m,
                    Quantity = 200,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Бренд:Stone Island\\r\\n \r\nМатеріал:Нейлон\\r\\n \r\nТип:Повсякденні штани\\r\\n \r\nПояс:Еластичний\\r\\n \r\nОбробка:Світловідбивне покриття\\r\\n \r\nСезон:Демісезонні\\r\\n \r\nКолір:Темно-сірий\\r\\n \r\nКраїна виробництва:Італія",
                    Price = 49.99m,
                    Quantity = 80,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Виробник:Karcher\\r\\n \r\nМодель:SC 4 Deluxe\\r\\n \r\nТип:Пароочисник\\r\\n \r\nПотужність:2000 Вт\\r\\n \r\nТиск пари:4.0 бар\\r\\n \r\nЧас нагріву:4 хв\\r\\n \r\nОб'єм бака:1.3 л\\r\\n \r\nЗнімний резервуар:Так\\r\\n \r\nНасадки в комплекті:Так\\r\\n \r\nКолір:Білий\\r\\n \r\nГарантія:24 міс.",
                    Price = 13999m,
                    Discount = 20m,
                    Quantity = 25,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Виробник:Gorenje\\r\\n \r\nМодель:HBX1000E\\r\\n \r\nТип:Занурювальний блендер\\r\\n \r\nПотужність:1000 Вт\\r\\n \r\nКількість швидкостей:2\\r\\n \r\nТурбо режим:Так\\r\\n \r\nМатеріал ніжки:Нержавіюча сталь\\r\\n \r\nПодрібнювач:500 мл\\r\\n \r\nКолір:Чорний\\r\\n \r\nГарантія:24 міс.",
                    Price = 1999m,
                    Discount = 15m,
                    Quantity = 40,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Бренд:LEGO\\r\\n \r\nСерія:Technic\\r\\n \r\nМодель:Ferrari Daytona SP3\\r\\n \r\nАртикул:42143\\r\\n \r\nКількість деталей:3778\\r\\n \r\nВік:18+\\r\\n \r\nМасштаб:1:8\\r\\n \r\nМатеріал:Пластик\\r\\n \r\nКраїна виробництва:Данія",
                    Price = 5499m,
                    Discount = 10m,
                    Quantity = 150,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Бренд:Країна Іграшок\\r\\n \r\nТип:Радіокерована машинка\\r\\n \r\nМасштаб:1:16\\r\\n \r\nТип керування:Пульт ДУ\\r\\n \r\nЖивлення:Акумулятор\\r\\n \r\nСвітлові ефекти:Так\\r\\n \r\nМатеріал:Пластик\\r\\n \r\nКолір:Салатовий\\r\\n \r\nВік:6+",
                    Price = 529m,
                    Discount = 5m,
                    Quantity = 70,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Автор:Mary Johnson\\r\\n \r\nМова:Українська\\r\\n \r\nЖанр:Кулінарія\\r\\n \r\nКількість сторінок:240\\r\\n \r\nФормат:М'яка обкладинка\\r\\n \r\nІлюстрації:Так\\r\\n \r\nРік видання:2023",
                    Price = 25.50m,
                    Quantity = 60,
                ...
                AddIfMissing(new Product
                {
                    ...
                    Specifications = "Виробник:Apple\\r\\n \r\nМодель:Apple Watch Series 9\\r\\n \r\nДіагональ дисплея:45 мм\\r\\n \r\nТип дисплея:Retina LTPO OLED\\r\\n \r\nРоздільна здатність:396×484\\r\\n \r\nПроцесор:Apple S9\\r\\n \r\nВбудована пам'ять:64 ГБ\\r\\n \r\nМатеріал корпусу:Алюміній\\r\\n \r\nЗахист від води:До 50 м\\r\\n \r\nGPS:Так\\r\\n \r\nBluetooth:5.3\\r\\n \r\nЧас роботи:До 18 годин\\r\\n \r\nСумісність:iPhone\\r\\n \r\nКолір:Midnight\\r\\n \r\nГарантія:12 міс.",
                    Price = 48999m,
                    Discount = 7m,
                    Quantity = 30,
