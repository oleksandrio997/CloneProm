    ...
    public static class SeedData
    {
        public static async Task InitializeAsync(this IServiceProvider services)
        {
            ...
            try
            {
                ...
                AddIfMissing("Notebook Alpha", new Models.Product { Name = "Notebook Alpha", Description = "Легкий ноутбук для повсякденних завдань.", Price = 149.99m, Quantity = 10, ImagePath = "https://via.placeholder.com/300x200?text=Notebook", CategoryId = electronics.Id, SellerId = seller1.Id });
                AddIfMissing("Wireless Mouse Mini", new Models.Product { Name = "Wireless Mouse Mini", Description = "Компактна ергономічна бездротова миша.", Price = 24.50m, Quantity = 50, ImagePath = "https://via.placeholder.com/300x200?text=Mouse", CategoryId = electronics.Id, SellerId = seller1.Id });
                AddIfMissing("Mechanical Keyboard X", new Models.Product { Name = "Mechanical Keyboard X", Description = "Механічна клавіатура із тактильними перемикачами.", Price = 89.90m, Quantity = 20, ImagePath = "https://via.placeholder.com/300x200?text=Keyboard", CategoryId = electronics.Id, SellerId = seller1.Id });

                AddIfMissing("Air Purifier Pro", new Models.Product { Name = "Air Purifier Pro", Description = "Компактний очисник для будинку.", Price = 129.00m, Quantity = 25, ImagePath = "https://via.placeholder.com/300x200?text=Air+Purifier", CategoryId = appliances.Id, SellerId = seller2.Id });
                AddIfMissing("Blender 500W", new Models.Product { Name = "Blender 500W", Description = "Потужний блендер для смузі та супів.", Price = 59.99m, Quantity = 40, ImagePath = "https://via.placeholder.com/300x200?text=Blender", CategoryId = appliances.Id, SellerId = seller2.Id });

                AddIfMissing("C# in Depth", new Models.Product { Name = "C# in Depth", Description = "Практичний посібник з C#.", Price = 39.99m, Quantity = 100, ImagePath = "https://via.placeholder.com/300x200?text=Book", CategoryId = books.Id, SellerId = seller3.Id });
                AddIfMissing("Cooking Basics", new Models.Product { Name = "Cooking Basics", Description = "Книга рецептів для початківців.", Price = 19.50m, Quantity = 60, ImagePath = "https://via.placeholder.com/300x200?text=Cookbook", CategoryId = books.Id, SellerId = seller3.Id });

                AddIfMissing("Classic T-Shirt", new Models.Product { Name = "Classic T-Shirt", Description = "Зручна бавовняна футболка.", Price = 14.99m, Quantity = 200, ImagePath = "https://via.placeholder.com/300x200?text=T-Shirt", CategoryId = clothing.Id, SellerId = seller1.Id });
                AddIfMissing("Denim Jeans", new Models.Product { Name = "Denim Jeans", Description = "Класичні джинси строгого крою.", Price = 49.99m, Quantity = 80, ImagePath = "https://via.placeholder.com/300x200?text=Jeans", CategoryId = clothing.Id, SellerId = seller1.Id });

                AddIfMissing("Building Blocks Set", new Models.Product { Name = "Building Blocks Set", Description = "Набір конструктор для дітей.", Price = 29.99m, Quantity = 150, ImagePath = "https://via.placeholder.com/300x200?text=Blocks", CategoryId = toys.Id, SellerId = seller2.Id });
                AddIfMissing("Remote Car Racer", new Models.Product { Name = "Remote Car Racer", Description = "Машинка на радіокеруванні для дітей", Price = 49.99m, Quantity = 70, ImagePath = "https://via.placeholder.com/300x200?text=Car", CategoryId = toys.Id, SellerId = seller2.Id });
